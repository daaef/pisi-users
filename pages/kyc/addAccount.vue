<template>
  <div v-if="!showSuccess" class="auth--view flex justify-center">
       ...
       <a href="#" @click="() => $router.go(-1)">
        ...
        <div class="w-full ">
          <div class="form-control w-full">
            <label class="label">
              <span class="label-text text-lg">Account Name</span>
            </label>
            <input
        ...
        <div class="w-full ">
          <div class="form-control w-full">
            <label class="label">
              <span class="label-text text-lg">Account Number</span>
            </label>
            <input
        ...
        <div class="w-full ">
          <div class="form-control w-full">
            <label class="label">
              <span class="label-text text-lg">Bank</span>
            </label>
            <select class="select  bg-base-content/10 input-bordered w-full">
  ...
  <success-kyc v-else title="Welcome to Exchange" buttonText="Continue to dashboard"  ></success-kyc>
